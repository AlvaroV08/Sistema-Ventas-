...
<div class="bs-callout <?php echo $cdr->isAccepted() ? 'bs-callout-success' : 'bs-callout-danger' ?>">
    ...
    <b>Adjuntos</b><br>
    <ul class="list-group">
        <li class="list-group-item"><a target="_blank" href="../empresa/files/<?=$filename?>.xml"><i class="fa fa-file-code"></i>&nbsp;<?=$filename?>.xml</a></li>
        <li class="list-group-item">
            <a target="_blank" href="../empresa/files/R-<?=$filename?>.zip"><i class="fa fa-file-archive"></i>&nbsp;R-<?=$filename?>.zip</a>&nbsp;

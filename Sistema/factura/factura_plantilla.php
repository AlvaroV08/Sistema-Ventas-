	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">JG MOTOS SOCIEDAD ANONIMA CERRADA</span>
					<p>AV. JOSE MATIAS MANZANILLA NRO. 750 URB. SAN MIGUEL</p>
					<p>ICA - ICA - ICA</p>
					<p>Teléfono:</p>
					<p>Email: JFMANCHEGO@hotmail.com</p>
				</div>
			</td>
			<td class="info_factura">
				<div class="round">
					<span class="h3">R.U.C. N° 20600566289</span>
	...
	<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th class="textright" width="150px">Precio Unit.</th>
					<th class="textright" width="150px"> Valor Unit.</th>
					<th class="textright" width="150px">Dcto.</th>
			...
			<tbody id="detalle_productos">
				<tr>
					...
					<td class="textright">516.67</td><td class="textcenter">1</td>
					<td>Plancha</td>
					<td class="textright">516.67</td>
					<td class="textright">516.67</td>
				</tr>
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="7" class="textright"><span>SUBTOTAL Q.</span></td>
					<td class="textright"><span>516.67</span></td>
				</tr>
				<tr>
					<td colspan="7" class="textright"><span>IVA (12%)</span></td>
					<td class="textright"><span>516.67</span></td>
				</tr>
				<tr>
					<td colspan="7" class="textright"><span>TOTAL Q.</span></td>
					<td class="textright"><span>516.67</span></td>
				</tr>
		</tfoot>
	</table>
